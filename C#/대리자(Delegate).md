...
- System 네임스페이스에 존재
- 0 ~ 16개의 입력 매개 변수를 가짐
- 사용자 지정 대리자를 명시적으로 선언하지 않고 메소드를 매개 변수로 전달하도록 함
- 매개 변수와 반환 값이 없는 것이 특징

<br/><br/>
Func 대리자
-------
- 0 ~ 16개의 입력 매개 변수를 가짐
- Action 대리자와는 달리 매개변수와 반환 값이 있음

<br/><br/>
Predicate대리자
-------
- 위 두 대리자와 비슷하지만 bool형이고 입력 매개 변수의 개수가 무조건 1개인 경우 사용
- <>에 반환 타입을 명시하지 않음
